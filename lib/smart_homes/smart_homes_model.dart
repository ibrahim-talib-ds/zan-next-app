...
import 'smart_homes_widget.dart' show SmartHomesWidget;
...
class SmartHomesModel extends FlutterFlowModel<SmartHomesWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_smarthomes = false;
  List<FFUploadedFile> uploadedLocalFiles_smarthomes = [];
  List<String> uploadedFileUrls_smarthomes = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'hpfzer5c' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'gh2667mh' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '4tnhzjjw' /* Please provide a description o... */,
      );
    }
