...
import 'dart:ui';
import '/index.dart';
import 'hair_care1_widget.dart' show HairCare1Widget;
...
class HairCare1Model extends FlutterFlowModel<HairCare1Widget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_hairCare = false;
  List<FFUploadedFile> uploadedLocalFiles_hairCare = [];
  List<String> uploadedFileUrls_hairCare = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'vgkd5ekb' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'i93hpswh' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '8xqedguo' /* Please provide a description o... */,
      );
    }
