...
import 'stationerys_widget.dart' show StationerysWidget;
...
class StationerysModel extends FlutterFlowModel<StationerysWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_stationeryS = false;
  List<FFUploadedFile> uploadedLocalFiles_stationeryS = [];
  List<String> uploadedFileUrls_stationeryS = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'f5hze7pl' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'v8x4e5x7' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'yjp99g22' /* Please provide a description o... */,
      );
    }
