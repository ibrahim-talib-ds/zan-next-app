...
import 'sandals_slippers_widget.dart' show SandalsSlippersWidget;
...
class SandalsSlippersModel extends FlutterFlowModel<SandalsSlippersWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_sandalsSlippers = false;
  List<FFUploadedFile> uploadedLocalFiles_sandalsSlippers = [];
  List<String> uploadedFileUrls_sandalsSlippers = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'qnv27be5' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'm5gx8p9t' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'wc5o8uyx' /* Please provide a description o... */,
      );
    }
