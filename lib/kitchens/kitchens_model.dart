...
import 'dart:ui';
import '/index.dart';
import 'kitchens_widget.dart' show KitchensWidget;
...
class KitchensModel extends FlutterFlowModel<KitchensWidget> {
  ...
  List<FFUploadedFile> uploadedLocalFiles_kitchen = [];
  List<String> uploadedFileUrls_kitchen = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'r79mayj8' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'gpjrqs3m' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'p8n1vg6j' /* Please provide a description o... */,
      );
    }
