...
import 'dart:ui';
import '/index.dart';
import 'fragrances1_widget.dart' show Fragrances1Widget;
...
class Fragrances1Model extends FlutterFlowModel<Fragrances1Widget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  bool isDataUploading_fragrances1 = false;
  List<FFUploadedFile> uploadedLocalFiles_fragrances1 = [];
  List<String> uploadedFileUrls_fragrances1 = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '0zrxupou' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'qiy72col' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'juzmlrb0' /* Please provide a description o... */,
      );
    }
