...
import 'dart:ui';
import '/index.dart';
import 'digital_watche_widget.dart' show DigitalWatcheWidget;
...
class DigitalWatcheModel extends FlutterFlowModel<DigitalWatcheWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  bool isDataUploading_digitalWatche = false;
  List<FFUploadedFile> uploadedLocalFiles_digitalWatche = [];
  List<String> uploadedFileUrls_digitalWatche = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '6syhjdqn' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'ams7g7nk' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'hjtw32d9' /* Please provide a description o... */,
      );
    }
