...
import 'wearable_widget.dart' show WearableWidget;
...
class WearableModel extends FlutterFlowModel<WearableWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_wearable = false;
  List<FFUploadedFile> uploadedLocalFiles_wearable = [];
  List<String> uploadedFileUrls_wearable = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'iz44yukx' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        's2y56mkr' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'mimtcai6' /* Please provide a description o... */,
      );
    }
