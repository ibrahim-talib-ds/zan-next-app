...
class GroceriesWidget extends StatefulWidget {
  ...
  static String routePath = '/groceries';
...
class _GroceriesWidgetState extends State<GroceriesWidget> {
  ...
  static const List<_Sub> _subs = [
    _Sub(
      label: 'Fresh Produce',
      subtitle: 'Fruits, vegetables, herbs',
      icon: Icons.eco_rounded,
    ),
    _Sub(
      label: 'Grains & Flour',
      subtitle: 'Rice, maize, wheat, flour',
    ...
    _Sub(
      label: 'Meat & Fish',
      subtitle: 'Beef, chicken, fish, goat',
      icon: Icons.set_meal_rounded,
    ),
    _Sub(
      label: 'Cooking Oil & Spices',
      subtitle: 'Oil, salt, pepper, spices',
    ...
    _Sub(
      label: 'Frozen Foods',
      subtitle: 'Frozen meats, veg, ready meals',
      icon: Icons.ac_unit_rounded,
    ),
    _Sub(
      label: 'Baby Food',
      subtitle: 'Formula, purees, cereal',
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Groceries'});
  ...
  Widget _subTile(BuildContext context, _Sub sub) {
    ...
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('GROCERIES_subcategory_ON_TAP');
