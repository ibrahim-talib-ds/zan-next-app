...
import 'supplement_widget.dart' show SupplementWidget;
...
class SupplementModel extends FlutterFlowModel<SupplementWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_supplement = false;
  List<FFUploadedFile> uploadedLocalFiles_supplement = [];
  List<String> uploadedFileUrls_supplement = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'zy8spfdu' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '3o8d9fip' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ma7ogrxg' /* Please provide a description o... */,
      );
    }
