...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF034C31);
  late Color secondary = const Color(0xFFF8FAF9);
  late Color tertiary = const Color(0xFF034C31);
  ...
  late Color secondaryBackground = const Color(0xFFF8FAF9);
  late Color accent1 = const Color(0xFFFFFFFF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF1EB414);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color customColor1 = const Color(0xFFEAEBF1);
  late Color customColor2 = const Color(0xFF034C31);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF034C31);
  late Color secondary = const Color(0xFF0F2A20);
  late Color tertiary = const Color(0xFF0A7A52);
  late Color alternate = const Color(0xFF0B1F17);
  late Color primaryText = const Color(0xFFA7C1B8);
  late Color secondaryText = const Color(0xFFA7C1B8);
  late Color primaryBackground = const Color(0xFF000000);
  late Color secondaryBackground = const Color(0xFF000000);
  late Color accent1 = const Color(0xFF123528);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  ...
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFF034C31);

  late Color customColor1 = const Color(0xFF195316);
  late Color customColor2 = const Color(0xFF034C31);
}
