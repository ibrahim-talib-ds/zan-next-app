...
String getCORSProxyUrl(String path) {
  ...
  const proxyUrl =
      'https://us-central1-zannext-f6ff1.cloudfunctions.net/corsProxy?url=';
...
// ==========================================
// GLOBAL FIX: Safe Named Stub for logFirebaseEvent
// ==========================================
extension LoggingExtension on State {
  Future<void> logFirebaseEvent(
    String eventName, {
    Map<String, dynamic>? parameters,
  }) async {
    // Safe stub to prevent compilation errors when analytics logging is called
  }
}

/// Bypass the FlutterFlow CORS proxy for ImgBB URLs — ImgBB already
/// serves its own images with proper CORS headers, and the proxy
/// mangles them on web.
String directImageUrl(String url) {
