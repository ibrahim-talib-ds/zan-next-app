...
import 'dart:ui';
import '/index.dart';
import 'mobile_accessorie_widget.dart' show MobileAccessorieWidget;
...
class MobileAccessorieModel extends FlutterFlowModel<MobileAccessorieWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_mobileAccessorie = false;
  List<FFUploadedFile> uploadedLocalFiles_mobileAccessorie = [];
  List<String> uploadedFileUrls_mobileAccessorie = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'w1jz8pdm' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '9mpce8oq' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'b9ddajs2' /* Please provide a description o... */,
      );
    }
