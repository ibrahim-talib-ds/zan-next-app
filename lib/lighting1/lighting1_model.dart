...
import 'dart:ui';
import '/index.dart';
import 'lighting1_widget.dart' show Lighting1Widget;
...
class Lighting1Model extends FlutterFlowModel<Lighting1Widget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_lighting1 = false;
  List<FFUploadedFile> uploadedLocalFiles_lighting1 = [];
  List<String> uploadedFileUrls_lighting1 = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '1sdp2jth' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'qivehb3u' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ee71f976' /* Please provide a description o... */,
      );
    }
