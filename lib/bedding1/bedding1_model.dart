...
import 'dart:ui';
import '/index.dart';
import 'bedding1_widget.dart' show Bedding1Widget;
...
class Bedding1Model extends FlutterFlowModel<Bedding1Widget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_bedding1 = false;
  List<FFUploadedFile> uploadedLocalFiles_bedding1 = [];
  List<String> uploadedFileUrls_bedding1 = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '71kn42dy' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'j7np8z2x' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'g507e34e' /* Please provide a description o... */,
      );
    }
