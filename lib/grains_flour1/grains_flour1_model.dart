...
import 'dart:ui';
import '/index.dart';
import 'grains_flour1_widget.dart' show GrainsFlour1Widget;
...
class GrainsFlour1Model extends FlutterFlowModel<GrainsFlour1Widget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_grainsFlour1 = false;
  List<FFUploadedFile> uploadedLocalFiles_grainsFlour1 = [];
  List<String> uploadedFileUrls_grainsFlour1 = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'x7i31gfg' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'gi0lukzg' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'w0vsye1u' /* Please provide a description o... */,
      );
    }
