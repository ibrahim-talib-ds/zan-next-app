...
import 'dart:ui';
import '/index.dart';
import 'audio_sounds_widget.dart' show AudioSoundsWidget;
...
class AudioSoundsModel extends FlutterFlowModel<AudioSoundsWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_audioSounds = false;
  List<FFUploadedFile> uploadedLocalFiles_audioSounds = [];
  List<String> uploadedFileUrls_audioSounds = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '5dwxgm0c' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '83rbozrt' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'h6nx0oqo' /* Please provide a description o... */,
      );
    }
