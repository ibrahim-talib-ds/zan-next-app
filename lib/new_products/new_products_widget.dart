...
class NewProductsWidget extends StatefulWidget {
  ...
  static String routeName = 'newProducts';
                      ...
                      child: Container(
                        ...
                        child: StreamBuilder<List<InventoryRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<InventoryRecord> gridViewInventoryRecordList =
                                snapshot.data!;
                            ...
                            return GridView.builder(
                              ...
                              itemCount: gridViewInventoryRecordList.length,
                              itemBuilder: (context, gridViewIndex) {
                                final gridViewInventoryRecord =
                                    gridViewInventoryRecordList[gridViewIndex];
                                return Padding(
                                      ...
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          'inventoryRef': serializeParam(
                                            gridViewInventoryRecord.reference,
                                                      ...
                                                      getCORSProxyUrl(
                                                        valueOrDefault<String>(
                                                          gridViewInventoryRecord
                                                              .inventoryImages
                                                              .firstOrNull,
                                                          'https://www.nike.com.kw/dw/image/v2/BDVB_PRD/on/demandware.static/-/Sites-akeneo-master-catalog/default/dw32486d25/nk/734/0/2/8/2/4/73402824_0b5a_42b6_88de_5b8071f56767.jpg?sw=700&sh=700&sm=fit&q=100&strip=false',
                                                        ),
                                                      ),
                                                      fit: BoxFit.contain,
                                                    ),
