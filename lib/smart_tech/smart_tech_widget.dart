...
import 'smart_tech_model.dart';
export 'smart_tech_model.dart';

class SmartTechWidget extends StatefulWidget {
  const SmartTechWidget({super.key});

  static String routeName = 'SmartTech';
  static String routePath = '/smartTech';

  @override
  State<SmartTechWidget> createState() => _SmartTechWidgetState();
}

class _SmartTechWidgetState extends State<SmartTechWidget> {
  late SmartTechModel _model;
  ...
  static const List<_Sub> _subs = [
    _Sub(
      label: 'Smart Home',
      subtitle: 'Hubs, controllers, sensors',
      icon: Icons.home_work_rounded,
    ),
    _Sub(
      label: 'Security Cameras',
      subtitle: 'Indoor, outdoor, doorbells',
      icon: Icons.videocam_rounded,
    ),
    _Sub(
      label: 'Smart Lighting',
      subtitle: 'Bulbs, strips, switches',
      icon: Icons.lightbulb_rounded,
    ),
    _Sub(
      label: 'Voice Assistants',
      subtitle: 'Echo, Google Home, speakers',
      icon: Icons.record_voice_over_rounded,
    ),
    _Sub(
      label: 'Smart Plugs',
      subtitle: 'Sockets, adapters, power strips',
      icon: Icons.power_rounded,
    ),
    _Sub(
      label: 'Thermostats',
      subtitle: 'Climate control, AC controllers',
    ...
    _Sub(
      label: 'Smart Locks',
      subtitle: 'Keyless entry, security',
      icon: Icons.lock_rounded,
    ),
    _Sub(
      label: 'Robot Vacuums',
      subtitle: 'Cleaning robots, mops',
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SmartTechModel());
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'SmartTech'});
  ...
  Widget _subTile(BuildContext context, _Sub sub) {
    ...
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('SMART_TECH_subcategory_ON_TAP');
