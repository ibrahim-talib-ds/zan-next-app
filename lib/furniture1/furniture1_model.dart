...
import 'dart:ui';
import '/index.dart';
import 'furniture1_widget.dart' show Furniture1Widget;
...
class Furniture1Model extends FlutterFlowModel<Furniture1Widget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_furniture1 = false;
  List<FFUploadedFile> uploadedLocalFiles_furniture1 = [];
  List<String> uploadedFileUrls_furniture1 = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '11pmt7u1' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'lpdwskkh' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'xbe865ry' /* Please provide a description o... */,
      );
    }
