...
import 'dart:ui';
import '/index.dart';
import 'beverages1_widget.dart' show Beverages1Widget;
...
class Beverages1Model extends FlutterFlowModel<Beverages1Widget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_beverages1 = false;
  List<FFUploadedFile> uploadedLocalFiles_beverages1 = [];
  List<String> uploadedFileUrls_beverages1 = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '4qskdjes' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '1imwxhwp' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '0wbl0spz' /* Please provide a description o... */,
      );
    }
