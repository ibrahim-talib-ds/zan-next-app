...
import 'select_seller_model.dart';
export 'select_seller_model.dart';

class SelectSellerWidget extends StatefulWidget {
  const SelectSellerWidget({super.key});

  static String routeName = 'selectSeller';
  static String routePath = '/selectSeller';
...
class _SelectSellerWidgetState extends State<SelectSellerWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectSellerModel());
