...
import 'dart:ui';
import '/index.dart';
import 'electronic_toy_widget.dart' show ElectronicToyWidget;
...
class ElectronicToyModel extends FlutterFlowModel<ElectronicToyWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  bool isDataUploading_electronicToy = false;
  List<FFUploadedFile> uploadedLocalFiles_electronicToy = [];
  List<String> uploadedFileUrls_electronicToy = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'z6id6u99' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'l5wpldez' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'qgcpmrhm' /* Please provide a description o... */,
      );
    }
