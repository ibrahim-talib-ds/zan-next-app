...
class _ElectronicsWidgetState extends State<ElectronicsWidget> {
  late ElectronicsModel _model;

  final scaffoldKey = GlobalKey<ScaffoldState>();

  // ------------------------------------------------------------
  // Every Electronics subcategory. Adding a new one = one line.
  ...
  static const List<_Sub> _subs = [
    ...
    _Sub(
      label: 'TV & Video',
      subtitle: 'Smart TVs, projectors, players',
    ...
    _Sub(
      label: 'Tablets',
      subtitle: 'iPad, Galaxy Tab, Android',
      icon: Icons.tablet_rounded,
    ),
    _Sub(
      label: 'Gaming',
      subtitle: 'Consoles, controllers, games',
      icon: Icons.sports_esports_rounded,
    ),
    _Sub(
      label: 'Networking',
      subtitle: 'Routers, extenders, cables',
    ...
    _Sub(
      label: 'Accessories',
      subtitle: 'Chargers, cases, adapters',
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ElectronicsModel());
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Electronics'});
  ...
  Widget _subTile(BuildContext context, _Sub sub) {
    ...
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('ELECTRONICS_subcategory_ON_TAP');
