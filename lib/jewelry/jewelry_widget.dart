...
export 'jewelry_model.dart';

class JewelryWidget extends StatefulWidget {
  const JewelryWidget({super.key});

  static String routeName = 'Jewelry';
  static String routePath = '/jewelry';

  @override
  State<JewelryWidget> createState() => _JewelryWidgetState();
}

class _JewelryWidgetState extends State<JewelryWidget> {
  late JewelryModel _model;
  ...
  static const List<_Sub> _subs = [
    ...
    _Sub(
      ...
      subtitle: 'Chains, lockets, statement',
      icon: Icons.workspace_premium_rounded,
    ),
    _Sub(
      label: 'Bracelets & Earrings',
      subtitle: 'Bangles, studs, hoops',
      icon: Icons.auto_awesome_rounded,
    ),
    _Sub(
      label: 'Luxury Watches',
      subtitle: 'Rolex, Omega, Patek',
      icon: Icons.watch_rounded,
    ),
    _Sub(
      label: 'Digital Watches',
      subtitle: 'Casio, G-Shock, fitness',
      icon: Icons.watch_later_rounded,
    ),
    _Sub(
      label: 'Brooches & Pins',
      subtitle: 'Vintage, modern, decorative',
      icon: Icons.push_pin_rounded,
    ),
    _Sub(
      label: 'Anklets & Toe Rings',
      subtitle: 'Traditional, modern',
      icon: Icons.gesture_rounded,
    ),
    _Sub(
      label: 'Jewelry Boxes',
      subtitle: 'Storage, travel, display',
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JewelryModel());
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Jewelry'});
  ...
  Widget _subTile(BuildContext context, _Sub sub) {
    ...
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('JEWELRY_subcategory_ON_TAP');
