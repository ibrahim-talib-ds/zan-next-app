...
import 'tires_rim_widget.dart' show TiresRimWidget;
...
class TiresRimModel extends FlutterFlowModel<TiresRimWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_rings = false;
  List<FFUploadedFile> uploadedLocalFiles_rings = [];
  List<String> uploadedFileUrls_rings = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'wc9b47kb' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'yahj40zg' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'glvyusia' /* Please provide a description o... */,
      );
    }
