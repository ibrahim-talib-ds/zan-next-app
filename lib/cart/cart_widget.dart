...
import '/components/deletepromt_widget.dart';
                                            ...
                                            child: Image.network(
                                              getCORSProxyUrl(
                                                valueOrDefault<String>(
                                                  listViewCartRecord
                                                      .inventoryImage,
                                                  'https://www.stkate.edu/sites/default/files/placeholder650x650.jpg',
                                                ),
                                              ),
                                              width: 64.0,
                                              height: 64.0,
                                                      ...
                                                      child: RichText(
                                                        ...
                                                        text: TextSpan(
                                                          children: [
                                                            ...
                                                            TextSpan(
                                                              text:
                                                                  '${listViewCartRecord.inventorySize}',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .titleMedium
                                                                  .override(
                                                            ...
                                                            TextSpan(
                                                              text:
                                                                  '${listViewCartRecord.inventoryColour}',
                                                              style: TextStyle(
                                                                fontWeight:
                                                                    FontWeight
                                                                        .w800,
                      ...
                      Flexible(
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              FFAppState().grandTotal = (_model.tax!) +
                                  FFAppState().grandTotal +
                                  (_model.shippingcost!);
                              safeSetState(() {});
