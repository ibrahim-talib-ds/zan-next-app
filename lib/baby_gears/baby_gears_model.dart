...
import 'dart:ui';
import '/index.dart';
import 'baby_gears_widget.dart' show BabyGearsWidget;
...
class BabyGearsModel extends FlutterFlowModel<BabyGearsWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_gear = false;
  List<FFUploadedFile> uploadedLocalFiles_gear = [];
  List<String> uploadedFileUrls_gear = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'zot2frae' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '1tws32oa' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'zewoje9v' /* Please provide a description o... */,
      );
    }
