...
class _HealthWidgetState extends State<HealthWidget> {
  ...
  static const List<_Sub> _subs = [
    _Sub(
      label: 'Supplements',
      subtitle: 'Vitamins, minerals, herbal',
      icon: Icons.medication_rounded,
    ),
    _Sub(
      label: 'Medical Equipment',
      subtitle: 'BP monitors, thermometers',
      icon: Icons.medical_services_rounded,
    ),
    _Sub(
      label: 'Personal Hygiene',
      subtitle: 'Sanitizers, masks, care kits',
      icon: Icons.sanitizer_rounded,
    ),
    _Sub(
      label: 'First Aid',
      subtitle: 'Bandages, antiseptics, kits',
      icon: Icons.healing_rounded,
    ),
    _Sub(
      label: 'Fitness Nutrition',
      subtitle: 'Protein, energy bars, shakes',
      icon: Icons.fitness_center_rounded,
    ),
    _Sub(
      label: 'Sexual Wellness',
      subtitle: 'Contraceptives, care products',
      icon: Icons.favorite_rounded,
    ),
    _Sub(
      label: 'Elderly Care',
      subtitle: 'Mobility aids, care products',
      icon: Icons.elderly_rounded,
    ),
    _Sub(
      label: 'Mental Wellness',
      subtitle: 'Relaxation, sleep aids',
  ...
  Widget _subTile(BuildContext context, _Sub sub) {
    ...
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('HEALTH_subcategory_ON_TAP');
