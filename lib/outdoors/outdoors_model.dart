...
import 'dart:ui';
import '/index.dart';
import 'outdoors_widget.dart' show OutdoorsWidget;
...
class OutdoorsModel extends FlutterFlowModel<OutdoorsWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_outdoors = false;
  List<FFUploadedFile> uploadedLocalFiles_outdoors = [];
  List<String> uploadedFileUrls_outdoors = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'qxl57pn8' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '947qd628' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '2rnhdhht' /* Please provide a description o... */,
      );
    }
