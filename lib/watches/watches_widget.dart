...
export 'watches_model.dart';

class WatchesWidget extends StatefulWidget {
  const WatchesWidget({super.key});

  static String routeName = 'Watches';
  static String routePath = '/watches';
...
class _WatchesWidgetState extends State<WatchesWidget> {
  ...
  static const List<_Sub> _subs = [
    _Sub(
      ...
      subtitle: 'Premium brands, automatic',
      icon: Icons.diamond_rounded,
    ),
    _Sub(
      label: 'Digital Watches',
      subtitle: 'LED, LCD, sports',
      icon: Icons.watch_rounded,
    ),
    _Sub(
      label: 'Smart Watches',
      subtitle: 'Apple, Samsung, Fitbit',
      icon: Icons.watch_later_rounded,
    ),
    _Sub(
      label: 'Classic Watches',
      subtitle: 'Dress, formal, vintage',
      icon: Icons.hourglass_bottom_rounded,
    ),
    _Sub(
      label: 'Sports Watches',
      subtitle: 'Diving, running, outdoor',
      icon: Icons.timer_rounded,
    ),
    _Sub(
      label: 'Kids Watches',
      subtitle: 'Fun designs for children',
      icon: Icons.child_friendly_rounded,
    ),
    _Sub(
      label: 'Watch Accessories',
      subtitle: 'Straps, batteries, tools',
      icon: Icons.build_rounded,
    ),
    _Sub(
      label: 'Wall Clocks',
      subtitle: 'Home, office, decorative',
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WatchesModel());
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Watches'});
  ...
  Widget _subTile(BuildContext context, _Sub sub) {
    ...
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('WATCHES_subcategory_ON_TAP');
