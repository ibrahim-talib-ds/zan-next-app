...
import 'dart:ui';
import '/index.dart';
import 'luxury_watche_widget.dart' show LuxuryWatcheWidget;
...
class LuxuryWatcheModel extends FlutterFlowModel<LuxuryWatcheWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_luxuryWatche = false;
  List<FFUploadedFile> uploadedLocalFiles_luxuryWatche = [];
  List<String> uploadedFileUrls_luxuryWatche = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'rbemlw3i' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '29754isb' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '9gmjy72k' /* Please provide a description o... */,
      );
    }
