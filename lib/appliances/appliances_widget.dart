...
class _AppliancesWidgetState extends State<AppliancesWidget> {
  ...
  static const List<_Sub> _subs = [
    _Sub(
      label: 'Kitchen',
      subtitle: 'Refrigerators, ovens, microwaves',
      icon: Icons.kitchen_rounded,
    ),
    _Sub(
      label: 'Laundry',
      subtitle: 'Washing machines, dryers',
      icon: Icons.local_laundry_service_rounded,
    ),
    _Sub(
      label: 'Cooling',
      subtitle: 'Air conditioners, fans, coolers',
      icon: Icons.ac_unit_rounded,
    ),
    _Sub(
      label: 'Heating',
      subtitle: 'Water heaters, space heaters',
      icon: Icons.whatshot_rounded,
    ),
    _Sub(
      label: 'Small Appliances',
      subtitle: 'Blenders, kettles, toasters',
      icon: Icons.blender_rounded,
    ),
    _Sub(
      label: 'Cleaning',
      subtitle: 'Vacuum cleaners, steam mops',
      icon: Icons.cleaning_services_rounded,
    ),
    _Sub(
      label: 'Water Treatment',
      subtitle: 'Purifiers, softeners, dispensers',
      icon: Icons.water_drop_rounded,
    ),
    _Sub(
      label: 'Home Comfort',
      subtitle: 'Humidifiers, dehumidifiers',
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Appliances'});
  ...
  Widget _subTile(BuildContext context, _Sub sub) {
    ...
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('APPLIANCES_subcategory_ON_TAP');
