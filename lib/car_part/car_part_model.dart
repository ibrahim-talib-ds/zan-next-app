...
import 'dart:ui';
import '/index.dart';
import 'car_part_widget.dart' show CarPartWidget;
...
class CarPartModel extends FlutterFlowModel<CarPartWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_carPart = false;
  List<FFUploadedFile> uploadedLocalFiles_carPart = [];
  List<String> uploadedFileUrls_carPart = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'biisinpl' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'esuytwgm' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'unp3mzq9' /* Please provide a description o... */,
      );
    }
