...
import 'dart:ui';
import '/index.dart';
import 'necklaces_pendant_widget.dart' show NecklacesPendantWidget;
...
class NecklacesPendantModel extends FlutterFlowModel<NecklacesPendantWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  bool isDataUploading_necklacesPendant = false;
  List<FFUploadedFile> uploadedLocalFiles_necklacesPendant = [];
  List<String> uploadedFileUrls_necklacesPendant = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'hy5brz6f' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '495wzgnj' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '28ptycbj' /* Please provide a description o... */,
      );
    }
