...
import 'wall_clock_widget.dart' show WallClockWidget;
...
class WallClockModel extends FlutterFlowModel<WallClockWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_wallClock = false;
  List<FFUploadedFile> uploadedLocalFiles_wallClock = [];
  List<String> uploadedFileUrls_wallClock = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ufebhvoz' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'madchs2j' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'd5siyg6k' /* Please provide a description o... */,
      );
    }
