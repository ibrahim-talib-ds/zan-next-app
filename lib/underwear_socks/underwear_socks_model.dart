...
import 'underwear_socks_widget.dart' show UnderwearSocksWidget;
...
class UnderwearSocksModel extends FlutterFlowModel<UnderwearSocksWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_underwearSocks = false;
  List<FFUploadedFile> uploadedLocalFiles_underwearSocks = [];
  List<String> uploadedFileUrls_underwearSocks = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'x8s1exu4' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '7c5p871n' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ozaa72jk' /* Please provide a description o... */,
      );
    }
