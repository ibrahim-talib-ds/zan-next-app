...
import 'snacks1_widget.dart' show Snacks1Widget;
...
class Snacks1Model extends FlutterFlowModel<Snacks1Widget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_snacks1 = false;
  List<FFUploadedFile> uploadedLocalFiles_snacks1 = [];
  List<String> uploadedFileUrls_snacks1 = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'l7esgky2' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'y1pnwaf5' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'zelke0xr' /* Please provide a description o... */,
      );
    }
