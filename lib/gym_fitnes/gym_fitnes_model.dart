...
import 'dart:ui';
import '/index.dart';
import 'gym_fitnes_widget.dart' show GymFitnesWidget;
...
class GymFitnesModel extends FlutterFlowModel<GymFitnesWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  bool isDataUploading_gymFitnes = false;
  List<FFUploadedFile> uploadedLocalFiles_gymFitnes = [];
  List<String> uploadedFileUrls_gymFitnes = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '11dq80c4' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'n3n768lh' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'csgr4699' /* Please provide a description o... */,
      );
    }
