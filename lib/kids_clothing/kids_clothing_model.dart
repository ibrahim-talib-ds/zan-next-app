...
import 'dart:ui';
import '/index.dart';
import 'kids_clothing_widget.dart' show KidsClothingWidget;
...
class KidsClothingModel extends FlutterFlowModel<KidsClothingWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_kidsClothing = false;
  List<FFUploadedFile> uploadedLocalFiles_kidsClothing = [];
  List<String> uploadedFileUrls_kidsClothing = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'm1qu9vow' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'rbitwpl8' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ninto9s7' /* Please provide a description o... */,
      );
    }
