...
import 'personal_hygienes_widget.dart' show PersonalHygienesWidget;
...
class PersonalHygienesModel extends FlutterFlowModel<PersonalHygienesWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_personalHygienes = false;
  List<FFUploadedFile> uploadedLocalFiles_personalHygienes = [];
  List<String> uploadedFileUrls_personalHygienes = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        't8xxmhh5' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'uzzmtbao' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '9k2alvji' /* Please provide a description o... */,
      );
    }
