...
import 'womens_wear_widget.dart' show WomensWearWidget;
...
class WomensWearModel extends FlutterFlowModel<WomensWearWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_women = false;
  List<FFUploadedFile> uploadedLocalFiles_women = [];
  List<String> uploadedFileUrls_women = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'rmx2ssif' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '8eom05vn' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'i45qflk4' /* Please provide a description o... */,
      );
    }
