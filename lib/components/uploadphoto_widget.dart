                            ...
                            Expanded(
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '6fsv0no9' /* Pakia picha mpya hapa chini il... */,
                                    ),
                                    ...
                                    image: Image.network(
                                      getCORSProxyUrl(
                                        valueOrDefault<String>(
                                          _model.uploadedFileUrl_uploadDataZvc,
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                        .isDataUploading_uploadDataZvc = true);
                                    ...
                                    try {
                                      ...
                                      ScaffoldMessenger.of(context)
                                          .hideCurrentSnackBar();
                                      _model.isDataUploading_uploadDataZvc =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        ...
                                        downloadUrls.length ==
                                            selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadDataZvc =
                                      ...
                                      showUploadMessage(
                                          context,
                                          FFLocalizations.of(context).getText(
                                            'xhsw1j1r' /* Failed to upload data. */,
                                          ));
                                      return;
                                    }
                                  }
