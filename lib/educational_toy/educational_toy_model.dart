...
import 'dart:ui';
import '/index.dart';
import 'educational_toy_widget.dart' show EducationalToyWidget;
...
class EducationalToyModel extends FlutterFlowModel<EducationalToyWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_educationalToy = false;
  List<FFUploadedFile> uploadedLocalFiles_educationalToy = [];
  List<String> uploadedFileUrls_educationalToy = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'x3epjz66' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'le7y4x9l' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '29tjl6pk' /* Please provide a description o... */,
      );
    }
