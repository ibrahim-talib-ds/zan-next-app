...
import 'dart:ui';
import '/index.dart';
import 'interior_accessor_widget.dart' show InteriorAccessorWidget;
...
class InteriorAccessorModel extends FlutterFlowModel<InteriorAccessorWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  bool isDataUploading_interiorAccessor = false;
  List<FFUploadedFile> uploadedLocalFiles_interiorAccessor = [];
  List<String> uploadedFileUrls_interiorAccessor = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'g29vj57q' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'x3umxktt' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '2ny2r7fa' /* Please provide a description o... */,
      );
    }
