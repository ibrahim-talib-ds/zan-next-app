...
import 'dart:ui';
import '/index.dart';
import 'bracelets_earring_widget.dart' show BraceletsEarringWidget;
...
class BraceletsEarringModel extends FlutterFlowModel<BraceletsEarringWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_braceletsEarrings = false;
  List<FFUploadedFile> uploadedLocalFiles_braceletsEarrings = [];
  List<String> uploadedFileUrls_braceletsEarrings = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ncvfaal8' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '6bep5h83' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '5b65kd2k' /* Please provide a description o... */,
      );
    }
