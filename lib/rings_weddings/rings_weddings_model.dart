...
import 'rings_weddings_widget.dart' show RingsWeddingsWidget;
...
class RingsWeddingsModel extends FlutterFlowModel<RingsWeddingsWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_ringsWedding1 = false;
  List<FFUploadedFile> uploadedLocalFiles_ringsWedding1 = [];
  List<String> uploadedFileUrls_ringsWedding1 = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'qcz5m1r6' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '1jdp6jqa' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ip179zo2' /* Please provide a description o... */,
      );
    }
