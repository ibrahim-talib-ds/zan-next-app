...
import 't_v_video1_widget.dart' show TVVideo1Widget;
...
class TVVideo1Model extends FlutterFlowModel<TVVideo1Widget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_tVVideo1 = false;
  List<FFUploadedFile> uploadedLocalFiles_tVVideo1 = [];
  List<String> uploadedFileUrls_tVVideo1 = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'mv9y7x8s' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '7uwr1p1g' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'l196vqpv' /* Please provide a description o... */,
      );
    }
