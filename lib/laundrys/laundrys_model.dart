...
import 'dart:ui';
import '/index.dart';
import 'laundrys_widget.dart' show LaundrysWidget;
...
class LaundrysModel extends FlutterFlowModel<LaundrysWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_laundrys = false;
  List<FFUploadedFile> uploadedLocalFiles_laundrys = [];
  List<String> uploadedFileUrls_laundrys = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'pwlqgmwh' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '5b2q15jc' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'sv3tzkel' /* Please provide a description o... */,
      );
    }
