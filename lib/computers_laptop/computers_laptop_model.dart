...
import 'dart:ui';
import '/index.dart';
import 'computers_laptop_widget.dart' show ComputersLaptopWidget;
...
class ComputersLaptopModel extends FlutterFlowModel<ComputersLaptopWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_computers = false;
  List<FFUploadedFile> uploadedLocalFiles_computers = [];
  List<String> uploadedFileUrls_computers = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '7aqespgj' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'ni5zipfn' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '5gyem9n5' /* Please provide a description o... */,
      );
    }
