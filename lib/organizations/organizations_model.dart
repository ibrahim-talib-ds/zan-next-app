...
class OrganizationsModel extends FlutterFlowModel<OrganizationsWidget> {
  ...
  bool isDataUploading_organizations = false;
  List<FFUploadedFile> uploadedLocalFiles_organizations = [];
  List<String> uploadedFileUrls_organizations = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '1fbbxj5m' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'wnm2j9uy' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'z6ar078i' /* Please provide a description o... */,
      );
    }
