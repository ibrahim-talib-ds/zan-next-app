...
import 'dart:ui';
import '/index.dart';
import 'fresh_produce1_widget.dart' show FreshProduce1Widget;
...
class FreshProduce1Model extends FlutterFlowModel<FreshProduce1Widget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_freshProduceFruitsVeg = false;
  List<FFUploadedFile> uploadedLocalFiles_freshProduceFruitsVeg = [];
  List<String> uploadedFileUrls_freshProduceFruitsVeg = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'io100x5p' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'm2wk3niq' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ypnukw7i' /* Please provide a description o... */,
      );
    }
