...
import 'skincare1_widget.dart' show Skincare1Widget;
...
class Skincare1Model extends FlutterFlowModel<Skincare1Widget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_skincare1 = false;
  List<FFUploadedFile> uploadedLocalFiles_skincare1 = [];
  List<String> uploadedFileUrls_skincare1 = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '7h1wx6h6' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '7znl51mv' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '4lrjtvt1' /* Please provide a description o... */,
      );
    }
