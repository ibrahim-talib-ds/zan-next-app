...
class GiftCardsWidget extends StatefulWidget {
  const GiftCardsWidget({super.key});

  static String routeName = 'GiftCards';
  static String routePath = '/GiftCards';
                  ...
                  child: StickyHeader(
                    ...
                    header: Row(
                      ...
                      children: [
                        Text(
                          FFLocalizations.of(context).getText(
                            '74s7hx2u' /* Select Gift Cards Category */,
                          ),
                          style:
