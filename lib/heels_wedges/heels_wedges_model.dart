...
import 'dart:ui';
import '/index.dart';
import 'heels_wedges_widget.dart' show HeelsWedgesWidget;
...
class HeelsWedgesModel extends FlutterFlowModel<HeelsWedgesWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_heelsWedges = false;
  List<FFUploadedFile> uploadedLocalFiles_heelsWedges = [];
  List<String> uploadedFileUrls_heelsWedges = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'g5937eps' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '3pp91dx3' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'cmkxn9w4' /* Please provide a description o... */,
      );
    }
