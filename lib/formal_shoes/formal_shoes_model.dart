...
import 'dart:ui';
import '/index.dart';
import 'formal_shoes_widget.dart' show FormalShoesWidget;
...
class FormalShoesModel extends FlutterFlowModel<FormalShoesWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  bool isDataUploading_formalShoes = false;
  List<FFUploadedFile> uploadedLocalFiles_formalShoes = [];
  List<String> uploadedFileUrls_formalShoes = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'o18jo93k' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'r9c6y60s' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ziccu5uv' /* Please provide a description o... */,
      );
    }
