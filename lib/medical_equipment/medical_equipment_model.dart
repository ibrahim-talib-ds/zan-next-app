...
import 'dart:ui';
import '/index.dart';
import 'medical_equipment_widget.dart' show MedicalEquipmentWidget;
...
class MedicalEquipmentModel extends FlutterFlowModel<MedicalEquipmentWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_medicalEquipment = false;
  List<FFUploadedFile> uploadedLocalFiles_medicalEquipment = [];
  List<String> uploadedFileUrls_medicalEquipment = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '63ycuibx' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'uzmsby3x' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'dty5tjyl' /* Please provide a description o... */,
      );
    }
