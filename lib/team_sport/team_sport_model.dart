...
import 'team_sport_widget.dart' show TeamSportWidget;
...
class TeamSportModel extends FlutterFlowModel<TeamSportWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_teamSport = false;
  List<FFUploadedFile> uploadedLocalFiles_teamSport = [];
  List<String> uploadedFileUrls_teamSport = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '4h8l1rrc' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '1fbcw8xh' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '1m8yxuyq' /* Please provide a description o... */,
      );
    }
