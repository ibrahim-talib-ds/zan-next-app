...
import 'sneakers_sports_widget.dart' show SneakersSportsWidget;
...
class SneakersSportsModel extends FlutterFlowModel<SneakersSportsWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  bool isDataUploading_sneakersSportss = false;
  List<FFUploadedFile> uploadedLocalFiles_sneakersSportss = [];
  List<String> uploadedFileUrls_sneakersSportss = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'xsr1vo3y' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'rtuiwz81' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'dywbzaxo' /* Please provide a description o... */,
      );
    }
