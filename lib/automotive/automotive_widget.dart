...
import 'automotive_model.dart';
export 'automotive_model.dart';

class AutomotiveWidget extends StatefulWidget {
  const AutomotiveWidget({super.key});

  static String routeName = 'Automotive';
  static String routePath = '/automotive';

  @override
  State<AutomotiveWidget> createState() => _AutomotiveWidgetState();
}

class _AutomotiveWidgetState extends State<AutomotiveWidget> {
  late AutomotiveModel _model;
  ...
  static const List<_Sub> _subs = [
    _Sub(
      label: 'Car Parts',
      subtitle: 'Engine, brakes, suspension',
      icon: Icons.build_circle_rounded,
    ),
    _Sub(
      label: 'Interior Accessories',
      subtitle: 'Seat covers, mats, organizers',
      icon: Icons.chair_alt_rounded,
    ),
    _Sub(
      label: 'Tires & Rims',
      subtitle: 'All-season, performance, off-road',
      icon: Icons.tire_repair_rounded,
    ),
    _Sub(
      label: 'Car Electronics',
      subtitle: 'Stereos, cameras, GPS',
      icon: Icons.electrical_services_rounded,
    ),
    _Sub(
      label: 'Car Care',
      subtitle: 'Wash, wax, polish, cleaning',
      icon: Icons.cleaning_services_rounded,
    ),
    _Sub(
      label: 'Tools & Equipment',
      subtitle: 'Jacks, wrenches, kits',
      icon: Icons.handyman_rounded,
    ),
    _Sub(
      label: 'Motorcycle Parts',
      subtitle: 'Helmets, exhausts, spares',
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AutomotiveModel());
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Automotive'});
  ...
  Widget _subTile(BuildContext context, _Sub sub) {
    ...
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('AUTOMOTIVE_subcategory_ON_TAP');
