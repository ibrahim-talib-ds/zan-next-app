...
import 'dart:ui';
import '/index.dart';
import 'office_techs_widget.dart' show OfficeTechsWidget;
...
class OfficeTechsModel extends FlutterFlowModel<OfficeTechsWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey3 = GlobalKey<FormState>();
  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  bool isDataUploading_officeTechs = false;
  List<FFUploadedFile> uploadedLocalFiles_officeTechs = [];
  List<String> uploadedFileUrls_officeTechs = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'o5xt4axj' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        'lf86xu7x' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '0s723xvy' /* Please provide a description o... */,
      );
    }
