...
import 'dart:ui';
import '/index.dart';
import 'heels_wedge_widget.dart' show HeelsWedgeWidget;
...
class HeelsWedgeModel extends FlutterFlowModel<HeelsWedgeWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey2 = GlobalKey<FormState>();
  final formKey1 = GlobalKey<FormState>();
  final formKey3 = GlobalKey<FormState>();
  bool isDataUploading_heel = false;
  List<FFUploadedFile> uploadedLocalFiles_heel = [];
  List<String> uploadedFileUrls_heel = [];
  ...
  String? _productNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'rjr9xmwc' /* Please enter a product name */,
      );
    }

    if (val.length > 60) {
      return FFLocalizations.of(context).getText(
        '6xx626z7' /* Name is too long. Use 60 chara... */,
      );
    }
  ...
  String? _productdescriptionTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'rpz1188w' /* Please provide a description o... */,
      );
    }
